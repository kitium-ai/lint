...
import { eslintBaseConfig, eslintReactConfig, eslintTypeScriptConfig } from '../index.js';
...
test('eslintTypeScriptConfig should have TypeScript-specific structure', () => {
  ...
  const tsConfig = eslintTypeScriptConfig.find((c) => c.name === 'kitium/typescript');
  ...
  assert(tsConfig.rules['@typescript-eslint/no-explicit-any'], 'should have TypeScript rules');
});
